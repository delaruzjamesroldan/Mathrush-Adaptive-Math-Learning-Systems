...
document.getElementById("navProfile").src =
"https://cdn-icons-png.flaticon.com/512/149/149071.png";

document.getElementById("gameProfile").src =
"https://cdn-icons-png.flaticon.com/512/149/149071.png";
}
...
if(stats.difficulty === "Medium") max = 30;
if(stats.difficulty === "Hard") max = 100;
...
document.getElementById("question").textContent = `${a} ${selectedOperation} ${b}`;
...
stats.wrong++;
document.getElementById("resultText").textContent = `Wrong! Correct Answer: ${currentAnswer}`;
}
...
document.getElementById("wrongDisplay").textContent = stats.wrong;
document.getElementById("accuracyDisplay").textContent = accuracy + "%";
document.getElementById("difficultyDisplay").textContent = stats.difficulty;

document.getElementById("progressCorrect").textContent = stats.correct;
document.getElementById("progressWrong").textContent = stats.wrong;
